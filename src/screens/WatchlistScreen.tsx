...
type WatchlistNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Watchlist'>;

const mockWatchlist: Anime[] = [
    {
        mal_id: 1,
...
export const WatchlistScreen = () => {
    ...
    const renderWatchlistItem = ({ item }: { item: Anime }) => (
        <TouchableOpacity
            style={[styles.watchlistItem, { backgroundColor: colors.card }]}
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        <Text style={{ color: colors.text }}>Your watchlist is empty</Text>
                    </View>
                }
            />
        </SafeAreaView>
